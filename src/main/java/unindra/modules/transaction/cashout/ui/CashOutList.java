...
public class CashOutList extends javax.swing.JFrame {
    ...
    public void loadData() {
        Object[] headers = { "Tanggal", "No. Referensi", "Dibayar Kepada", "Dibayar Dengan", "Untuk Pembayaran",
                "Nilai Pembayaran" };
    ...
    private void initComponents() {
        ...
        dataTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal", "No. Referensi", "Dibayar Kepada", "Dibayar Dengan", "Untuk Pembayaran", "Nilai Pembayaran"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashOutList.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);

...
public class CashInForm extends javax.swing.JFrame {
    ...
    private void save() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Nilai penerimaan harus berupa angka.");
        }
    ...
    private void initComponents() {
        ...
        lAmount3.setText("Diterima Melalui");
        ...
        lAmount4.setText("Penerimaan Atas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashInForm.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CashInForm(null, null).setVisible(true);
            }
        });
    }

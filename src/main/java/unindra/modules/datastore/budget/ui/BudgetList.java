...
public class BudgetList extends javax.swing.JFrame {

    private Consumer<Budget> callback;

    public static void openLookup(Consumer<Budget> callback) {
        BudgetList lookup = new BudgetList();
    ...
    public void setCallback(Consumer<Budget> callback) {
    ...
    public void loadData() {
        ...
        List<Budget> list = BudgetService.find(fSearch.getText());
        for (Budget data : list) {
            model.addRow(new Object[] {
                    data.getCoaName(),
                    data.getPeriodStart().format(Config.dateFormatter()),
                    data.getPeriodEnd().format(Config.dateFormatter()),
    ...
    private void initComponents() {
        ...
        title.setText("Perencanaan Anggaran");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BudgetList.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);

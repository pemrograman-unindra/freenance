...
public class ReportBalanceSheet extends javax.swing.JFrame {
                    ...
                    .addGroup(background1Layout.createSequentialGroup()
                        ...
                        .addGroup(background1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(background1Layout.createSequentialGroup()
                                .addComponent(lUser)
                                .addGap(41, 41, 41)
                                .addComponent(fDate, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(background1Layout.createSequentialGroup()
                        .addGap(177, 177, 177)
                        .addComponent(lUser1)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportBalanceSheet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

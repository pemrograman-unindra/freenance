...
public class ReportProject extends javax.swing.JFrame {
    ...
    private void open() {
        try {
            InputStream file = MainMenu.class.getResourceAsStream("/reports/project.jasper");
            ...
            JFrame frame = new JFrame("Laporan Proyek");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportProject.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);

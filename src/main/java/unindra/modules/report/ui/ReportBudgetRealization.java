...
public class ReportBudgetRealization extends javax.swing.JFrame {

    public ReportBudgetRealization() {
        initComponents();
        pack();
    ...
    private void open() {
        try {
            InputStream file = MainMenu.class.getResourceAsStream("/reports/budget-realization.jasper");
            ...
            JFrame frame = new JFrame("Laporan Realisasi Anggaran");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportBudgetRealization.class.getName())

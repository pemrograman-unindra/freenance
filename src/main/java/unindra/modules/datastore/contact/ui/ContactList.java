...
public class ContactList extends javax.swing.JFrame {
    ...
    private void delete() {
        ...
        if (selectedRow != -1) {
            ...
            int confirm = JOptionPane.showConfirmDialog(this,
                    "Apakah kamu yakin akan menghapus data kontak " + data.getName() + "?", "Konfirmasi",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContactList.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);

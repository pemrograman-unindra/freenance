# Use Case Diagram - Sistem Berjalan (Zahir Accounting)

Berdasarkan analisis proses bisnis sistem berjalan, Use Case dibagi menjadi beberapa modul untuk memudahkan pembacaan.

## Identifikasi Aktor
- **Admin Sistem**: Mengelola konfigurasi (RBAC), import/export, dan backup/restore database.
- **Bagian Penjualan (Sales)**: Menangani data kontak pelanggan, penawaran, dan pesanan penjualan.
- **Bagian Pembelian (Purchasing)**: Menangani data kontak vendor, request for quotation, dan pesanan pembelian.
- **Bagian Gudang (Warehouse)**: Mengelola data produk/gudang, keluar masuk barang (Delivery/Receipt), stok opname, dan produksi.
- **Bagian Keuangan (Finance)**: Mengelola data akun/harta tetap, faktur, pembayaran, kas/bank, jurnal umum, dan laporan keuangan.
- **Manajemen/Pimpinan**: Melihat laporan dan memberikan persetujuan (approval).
- **Semua Pengguna**: Login/Logout, Multi-entitas.

---

## 1. Modul Manajemen Data Master & Konfigurasi
...
## 4. Manajemen Persediaan & Produksi

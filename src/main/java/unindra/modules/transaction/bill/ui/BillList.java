...
public class BillList extends javax.swing.JFrame {
    ...
    public void setCallback(Consumer<Transaction> callback) {
        ...
        title.setText("Pilih Tagihan");
    }

    public void loadData() {
        Object[] headers = { "Tanggal", "No. Referensi", "Kepada", "Tagihan Atas", "Nilai Tagihan" };
    ...
    private void create() {
        new BillForm(this, null).setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        dataTable.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "Tanggal", "No. Referensi", "Kepada", "Tagihan Atas", "Nilai Tagihan"
                }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillList.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);

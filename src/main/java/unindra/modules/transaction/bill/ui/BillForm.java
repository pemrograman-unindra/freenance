...
public class BillForm extends javax.swing.JFrame {
    ...
    private void lookupContact() {
        ContactList.openLookup(data -> {
            if (data != null) {
                ...
                originCoaId = data.getBillCoaId();
                if (originCoaId == 0) {
                    Coa c = new Coa();
                    c.setCode(CoaService.nextCodeByParentId(2));
                    c.setName("Utang Kepada " + data.getName());
                    c.setParentId(2);
                    c.setCategoryId(2);
                    c.setIsCash(false);
                    originCoaId = CoaService.create(c);
                }
            }
        });
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillForm.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BillForm(null, null).setVisible(true);
            }
        });
    }

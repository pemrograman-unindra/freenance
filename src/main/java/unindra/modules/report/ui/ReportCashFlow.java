...
public class ReportCashFlow extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportCashFlow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
